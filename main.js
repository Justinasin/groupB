function addAboutUs() {
    var text = `<h1 class="articleName1">This is about us page</h1>
...
function addPricing() {
    var text = `<h1 class="articleName1">This is pricing page</h1>
...
function addContacts() {
    var text = `<h1 class="articleName1">This is contact page</h1>
